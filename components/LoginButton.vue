<template>
  <div>
    ...
    <button
      v-else-if="googleSignInEnabled"
      @click="handleGoogleSignIn"
      :disabled="isSigningIn"
      class="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 disabled:opacity-60 disabled:cursor-not-allowed transition-colors flex items-center gap-2"
    >
...
const { public: { googleSignInEnabled } } = useRuntimeConfig()
